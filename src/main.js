...
moonCoin.createTransaction(new Transaction_1.Transaction("address1", "address2", 5));
moonCoin.createTransaction(new Transaction_1.Transaction("address2", "address1", 3));
moonCoin.minePendingTransactions("address3");
moonCoin.createTransaction(new Transaction_1.Transaction("address1", "address2", 50));
moonCoin.createTransaction(new Transaction_1.Transaction("address2", "address1", 30));
moonCoin.minePendingTransactions("address3");
